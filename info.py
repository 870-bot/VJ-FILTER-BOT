...
API_ID = int(environ.get('API_ID', '23457611'))
API_HASH = environ.get('API_HASH', '5640c394942dba67388b7082b063a27d')
BOT_TOKEN = environ.get('BOT_TOKEN', "7955529477:AAFr4cyKCLVZ8bLHgDRUQzo2QWAS-yjH6V8")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://files.catbox.moe/i1zxxm.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '8054338621').split()] # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002871637084') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002736411921')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ganeshsharma2346:aayu2005yuji@mrkevin870.qbp4gwg.mongodb.net/?retryWrites=true&w=majority&appName=MRKEVIN870")   # IF Multiple Database Is False Then Fill Only This Database Url.
